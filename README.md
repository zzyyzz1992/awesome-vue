...
### Apps/Websites
  ...
  - [HUAWEI Cloud](https://cloud.huawei.com/) - HUAWEI Cloud is a data storage platform that securely stores and backs up your important data, including your photos, videos, and contacts, and provides you with common data services, such as simultaneous updates on multiple devices, automatic data backup, Find My Phone, space expansion, and space management.
